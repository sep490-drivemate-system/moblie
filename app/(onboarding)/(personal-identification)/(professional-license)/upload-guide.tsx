...
export default function UploadGuideScreen() {
  ...
  const openCamera = async () => {
    ...
    if (!result.canceled) {
      ...
      await AsyncStorage.setItem("temp_certificate", result.assets[0].uri);
  ...
  const getSampleImages = () => {
    return [require("@/assets/images/image_1-guide4.png")];
  };
      ...
      >
        <View style={styles.content}>
          ...
          <Text style={styles.title}>
            Hướng dẫn tải lên chứng chỉ hành nghề giảng dạy lái xe
          </Text>
          ...
          <View style={styles.requirementsContainer}>
            <View style={styles.requirementSection}>
              ...
              <View style={styles.requirementList}>
                ...
                <Text style={styles.requirementItem}>
                  • Chứng chỉ được cấp bởi cơ quan có thẩm quyền
                </Text>
                <Text style={styles.requirementItem}>
                  • Chứng chỉ có đầy đủ thông tin cá nhân và hạng xe đào tạo
                </Text>
                <Text style={styles.requirementItem}>
            ...
            <View style={styles.requirementSection}>
              ...
              <View style={styles.requirementList}>
                <Text style={styles.requirementItem}>
                  • Chứng chỉ chụp đầy đủ các thông tin, không mất góc
                </Text>
                <Text style={styles.requirementItem}>
                  • Hình ảnh không được chụp quá tầm mắt nhìn
                </Text>
                <Text style={styles.requirementItem}>
                  • Không chụp ảnh qua màn hình hoặc sử dụng chứng chỉ scan. Ảnh
