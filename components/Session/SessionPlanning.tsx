...
export default function RoutePlanning() {
  ...
  // Fetch sessions with Planning status
  const fetchSessions = async () => {
    try {
      ...
      const result = await dispatch(
        getAllSessions({ status: SessionStatus.Planning })
      ).unwrap();
      ...
      console.log("Failed to fetch planning sessions:", err);
      ...
      >
        <View style={styles.headerContent}>
          <View style={styles.headerTextContainer}>
            <Text style={styles.headerTitle}>Lên lộ trình</Text>
            <Text style={styles.headerSubtitle}>
              Danh sách các buổi huấn luyện cần lên lộ trình
            </Text>
          </View>
        ...
        {isLoading && sessions.length === 0 ? (
          ...
          <View style={styles.emptyState}>
            <View style={styles.emptyIconContainer}>
              <Navigation size={48} color={AppColors.primary} strokeWidth={1.5} />
            </View>
            <Text style={styles.emptyTitle}>
              Chưa có buổi huấn luyện cần lên lộ trình
            </Text>
            <Text style={styles.emptySubtitle}>
              Các buổi huấn luyện có trạng thái "Lên lộ trình" sẽ hiển thị ở đây
            </Text>
          </View>
        ) : (
                  ...
                  <View style={styles.cardHeader}>
                    <View style={styles.statusBadge}>
                      <Navigation
                        ...
                        strokeWidth={2}
                      />
                      <Text style={[styles.statusText, { color: AppColors.primary }]}>
                        Lên lộ trình
                      </Text>
                    </View>
